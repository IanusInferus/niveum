...
namespace Niveum.ObjectSchema.PythonJson
{
    ...
    {
        public static String CompileToPythonJson(this Schema Schema)
        {
            return CompileToPythonJson(Schema, "");
        }
    ...
    public partial class Templates
    {
        ...
        {
            return Inner.GetXmlComment(Description);
        }
        public String GetSimpleName(TypeSpec Type, String NamespaceName)
        {
            return Type.SimpleName(NamespaceName);
        }
