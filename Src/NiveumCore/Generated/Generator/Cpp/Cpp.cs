...
namespace Niveum.ObjectSchema.Cpp
{
    partial class Templates
    {
        ...
        {
            yield return "#ifndef _OPTIONAL_TYPE_";
            yield return "    enum class OptionalTag";
            yield return "    {";
            yield return "        NotHasValue = 0,";
            yield return "        HasValue = 1";
            yield return "    };";
            yield return "    /* TaggedUnion */";
            yield return "    template<typename T>";
            yield return "    class Optional final";
            yield return "    {";
            yield return "    public:";
            yield return "        /* Tag */ OptionalTag _Tag;";
            yield return "";
            yield return "        Unit NotHasValue;";
            yield return "        T HasValue;";
            yield return "";
            yield return "        static Optional<T> CreateNotHasValue()";
            yield return "        {";
            yield return "            auto r = Optional<T>();";
            yield return "            r._Tag = OptionalTag::NotHasValue;";
            yield return "            r.NotHasValue = Unit();";
            yield return "            return r;";
            yield return "        }";
            yield return "        static Optional<T> CreateHasValue(T Value)";
            yield return "        {";
            yield return "            auto r = Optional<T>();";
            yield return "            r._Tag = OptionalTag::HasValue;";
            yield return "            r.HasValue = Value;";
            yield return "            return r;";
            yield return "        }";
            yield return "";
            yield return "        Boolean OnNotHasValue() const";
            yield return "        {";
            yield return "            return _Tag == OptionalTag::NotHasValue;";
            yield return "        }";
            yield return "        Boolean OnHasValue() const";
            yield return "        {";
            yield return "            return _Tag == OptionalTag::HasValue;";
            yield return "        }";
            yield return "";
            yield return "        static Optional<T> Empty() { return CreateNotHasValue(); }";
            yield return "        Optional()";
            yield return "            : _Tag(OptionalTag::NotHasValue),";
            yield return "              NotHasValue(Unit()),";
            yield return "              HasValue(T())";
            yield return "        {";
            yield return "        }";
            yield return "        Optional(const T &v)";
            yield return "            : _Tag(OptionalTag::HasValue),";
            yield return "              NotHasValue(Unit()),";
            yield return "              HasValue(v)";
            yield return "        {";
            yield return "        }";
            yield return "        Optional(std::nullptr_t v)";
            yield return "            : _Tag(OptionalTag::NotHasValue),";
            yield return "              NotHasValue(Unit()),";
            yield return "              HasValue(T())";
            yield return "        {";
            yield return "        }";
            yield return "        explicit operator const T &() const";
            yield return "        {";
            yield return "            if (OnNotHasValue())";
            yield return "            {";
            yield return "                throw std::logic_error(\"InvalidOperation\");";
            yield return "            }";
            yield return "            return HasValue;";
            yield return "        }";
            yield return "        Boolean operator ==(const Optional<T> &Right) const";
            yield return "        {";
            yield return "            return Equals(*this, Right);";
            yield return "        }";
            yield return "        Boolean operator !=(const Optional<T> &Right) const";
            yield return "        {";
            yield return "            return !Equals(*this, Right);";
            yield return "        }";
            yield return "        Boolean operator ==(const T &Right) const";
            yield return "        {";
            yield return "            return Equals(*this, static_cast<const Optional<T> &>(Right));";
            yield return "        }";
            yield return "        Boolean operator !=(const T &Right) const";
            yield return "        {";
            yield return "            return !Equals(*this, static_cast<const Optional<T> &>(Right));";
            yield return "        }";
            yield return "        Boolean operator ==(std::nullptr_t Right) const";
            yield return "        {";
            yield return "            return Equals(*this, Right);";
            yield return "        }";
            yield return "        Boolean operator !=(std::nullptr_t Right) const";
            ...
            yield return "        static Boolean Equals(const Optional<T> &Left, const Optional<T> &Right)";
            yield return "        {";
            ...
            yield return "            }";
            yield return "            return Left.HasValue == Right.HasValue;";
            yield return "        }";
            yield return "        static Boolean Equals(const Optional<T> &Left, std::nullptr_t Right)";
            yield return "        {";
            yield return "            return Left.OnNotHasValue();";
            yield return "        }";
            yield return "";
            yield return "    public:";
            yield return "        T Value() const";
            yield return "        {";
            ...
            yield return "            }";
            yield return "        }";
            yield return "        T ValueOrDefault(T Default) const";
            yield return "        {";
            yield return "            if (OnHasValue())";
            yield return "            {";
            yield return "                return HasValue;";
            ...
            yield return "    };";
            yield return "";
            yield return "    namespace std";
            yield return "    {";
            yield return "        template <typename T>";
            yield return "        struct hash<Optional<T>>";
            yield return "        {";
            yield return "            size_t operator()(const Optional<T> &x) const";
            yield return "            {";
            yield return "                if (x.OnNotHasValue()) { return 0; }";
            yield return "                return hash<T>()(x.HasValue);";
            yield return "            }";
            yield return "        };";
            yield return "        template <typename T>";
            yield return "        struct less<Optional<T>>";
            yield return "        {";
            yield return "            bool operator()(const Optional<T> &x, const Optional<T> &y) const";
            yield return "            {";
            yield return "                if ((x == nullptr) && (y == nullptr)) { return false; }";
            yield return "                if (x == nullptr) { return true; }";
            yield return "                if (y == nullptr) { return false; }";
            yield return "                return x.HasValue < y.HasValue;";
            yield return "            }";
            yield return "        };";
            yield return "    }";
            yield return "";
