    ...
    public static class CodeGenerator
    {
        ...
        public class Writer
        {
            ...
            public List<String> GetJsonTranslatorSerializers()
            {
                ...
                {
                    l.AddRange(GetJsonTranslatorRecord(new RecordDef { Name = t.TypeFriendlyName(), Version = "", GenericParameters = new List<VariableDef> { }, Fields = t.Tuple.Select((tp, i) => new VariableDef { Name = String.Format("Item{0}", i), Type = tp, Description = "" }).ToList(), Description = "" }));
                    l.Add("");
                }
