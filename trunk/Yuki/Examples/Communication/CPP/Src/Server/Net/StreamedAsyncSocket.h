...
namespace Communication
{
    namespace Net
    {
        ...
        private:
            ...
            Communication::BaseSystem::AutoResetEvent NumAsyncOperationUpdated;
            Communication::BaseSystem::LockedVariable<int> NumAsyncOperation;
        ...
        private:
            ...
            void DoSendAsync(std::shared_ptr<SendAsyncParameters> p)
            {
                auto Release = [=]()
                {
                    Communication::BaseSystem::AutoRelease Final([=]() { this->ReleaseAsyncOperation(); });
