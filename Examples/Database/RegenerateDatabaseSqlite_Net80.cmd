...
@if not exist ..\..\Bin\net8.0\Microsoft.Data.Sqlite.dll (
  @echo Niveum\Bin\net8.0ÖÐ²»´æÔÚMicrosoft.Data.Sqlite.dll¡£
  @pause
  @exit
)

DatabaseRegenerator.exe /loadtyperef:CommonSchema /loadtype:MailSchema /connect:"Data Source=MailCSharp\Bin\Mail.sqlite" /database:Mail /regensqlite:MailData
DatabaseRegenerator.exe /loadtyperef:CommonSchema /loadtype:TestSchema /connect:"Data Source=TestCSharp\Bin\Test.sqlite" /database:Test /regensqlite:TestData
