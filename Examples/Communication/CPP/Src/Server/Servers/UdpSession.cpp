...
namespace Server
{
    ...
    void UdpSession::RaiseError(std::u16string CommandName, std::u16string Message)
    {
        si->RaiseError(CommandName, Message);
    }
    void UdpSession::RaiseUnknownError(std::u16string CommandName, const std::exception &ex)
    {
